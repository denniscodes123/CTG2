...
namespace CTG2.Content
{
    public class Abilities : ModPlayer
    {
        ...
        public override void PostItemCheck() // Upon activation
        {
            ...
            if (((Player.HeldItem.type == ItemID.WhoopieCushion && Player.controlUseItem && Player.itemTime == 0) || CTG2.Ability1Keybind.JustPressed) && cooldown == 0) // Only activate if not on cooldown
            {
